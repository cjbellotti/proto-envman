EnvMan.Views.EntidadImportarMRIBS = Backbone.View.extend({
	...
	cargarTabla : function (e) {
			...
			espera.show();
      var self = this;
      window.generales.datosTabla('DVM_ENTIDAD_CANONICA_MRIBS', ambiente, function (lista) {

        espera.hide();

        var arrayData = [];
        for (var index in lista) {
          if (_.findIndex(job.registros['DVM_ENTIDAD_CANONICA_MRIBS'], lista[index]) < 0)
