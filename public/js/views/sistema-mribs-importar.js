EnvMan.Views.SistemaImportarMRIBS = Backbone.View.extend({
	...
	cargarTabla : function (e) {
			...
			espera.show();
      var self = this;
      window.generales.datosTabla('DVM_SISTEMA_MRIBS', ambiente, function (lista) {

        espera.hide();

        var arrayData = [];
        for (var index in lista) {
          if (_.findIndex(job.registros['DVM_SISTEMA_MRIBS'], lista[index]) < 0)
